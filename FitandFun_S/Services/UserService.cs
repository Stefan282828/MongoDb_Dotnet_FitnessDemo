...
namespace FitandFun.Services{
    ...
    public class UserService : IUserService
    {
        ...
        public async Task AddWorkout(string userId, string workoutName)
        {
            ...
            workout.UserIds ??= new List<string>(); // Inicijalizacija liste ako je null
    ...
    public async Task<User> GetIdByUsername(string username)
    {
        ...
        {
            Console.WriteLine($"Greška prilikom dobijanja korisnika po korisničkom imenu: {ex.Message}");
            throw;
        }
    }
